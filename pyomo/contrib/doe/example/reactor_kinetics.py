...
def create_model(m=None, control_time=None, control_val=None, 
    ...
    m.A1 = pyo.Var(initialize = theta['A1'], mutable=True)
    m.A2 = pyo.Var(initialize = theta['A2'], mutable=True)
    m.E1 = pyo.Var(initialize = theta['E1'], mutable=True)
    m.E2 = pyo.Var(initialize = theta['E2'], mutable=True)
